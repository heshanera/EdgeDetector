...
${OBJECTDIR}/_ext/1146eab9/Canny.o: /home/heshan/NetBeansProjects/Line\ Detection/Canny.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags Magick++`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1146eab9/Canny.o /home/heshan/NetBeansProjects/Line\ Detection/Canny.cpp

${OBJECTDIR}/_ext/1146eab9/DetectLine.o: /home/heshan/NetBeansProjects/Line\ Detection/DetectLine.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1146eab9
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags Magick++`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1146eab9/DetectLine.o /home/heshan/NetBeansProjects/Line\ Detection/DetectLine.cpp

${OBJECTDIR}/_ext/1146eab9/Skeletonize.o: /home/heshan/NetBeansProjects/Line\ Detection/Skeletonize.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/1146eab9
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags Magick++`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1146eab9/Skeletonize.o /home/heshan/NetBeansProjects/Line\ Detection/Skeletonize.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags Magick++`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
